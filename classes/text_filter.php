...
if (class_exists('\core_filters\text_filter')) {
    class_alias('\core_filters\text_filter', 'filter_courseprofesores_base_text_filter');
} else {
    class_alias('\moodle_text_filter', 'filter_courseprofesores_base_text_filter');
}
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class text_filter extends \filter_courseprofesores_base_text_filter {
